...
export default {
  ...
  data() {
    return {
      ...
      locationDetails: {
        customStartingX: null,
        customStartingY: null,
        customEndingX: null,
        customEndingY: null,
        sector: null,
        system: null,
    ...
    async onSubmit () {
      ...
      await this.$store.dispatch(CREATE_MISSION_ACTION, {
        formData: {
          ...
          customStartingX: this.locationDetails.customStartingX ? this.locationDetails.customStartingX : null,
          customStartingY: this.locationDetails.customStartingY ? this.locationDetails.customStartingY : null,
          customEndingX: this.locationDetails.customEndingX ? this.locationDetails.customEndingX : null,
          customEndingY: this.locationDetails.customEndingY ? this.locationDetails.customEndingY : null,
