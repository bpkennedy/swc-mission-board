    ...
    async onSubmit () {
      ...
      await this.$store.dispatch(CREATE_MISSION_ACTION, {
        formData: {
          ...
          startingSector: this.locationDetails.sector.value ? this.locationDetails.sector.value : '',
          startingSystem: this.locationDetails.system.value ? this.locationDetails.system.value : '',
          endingSector: this.locationDetails.sectorEnd.value ? this.locationDetails.sectorEnd.value : '',
          endingSystem: this.locationDetails.systemEnd.value ? this.locationDetails.systemEnd.value : '',
